...
import { getGamingPcById } from 'apiSdk/gaming-pcs';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Gaming Pc Detail View
          </Text>
          {hasAccess('gaming_pc', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/gaming-pcs/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/bookings/create?gaming_pc_id=${data?.id}`}>
