            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>start_time</Th>
                  <Th>end_time</Th>
                  {hasAccess('gaming_pc', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>gaming_pc</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('gaming_pc', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/gaming-pcs/view/${record.gaming_pc?.id}`}>
                          {record.gaming_pc?.name}
                        </Link>
                      </Td>
                    )}
