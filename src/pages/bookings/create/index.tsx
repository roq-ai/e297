...
import { getGamingPcs } from 'apiSdk/gaming-pcs';
...
function BookingCreatePage() {
  ...
  const formik = useFormik<BookingInterface>({
    initialValues: {
      ...
      gaming_pc_id: (router.query.gaming_pc_id as string) ?? null,
    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<GamingPcInterface>
            formik={formik}
            name={'gaming_pc_id'}
            label={'Select Gaming Pc'}
            placeholder={'Select Gaming Pc'}
            fetcher={getGamingPcs}
            renderOption={(record) => (
